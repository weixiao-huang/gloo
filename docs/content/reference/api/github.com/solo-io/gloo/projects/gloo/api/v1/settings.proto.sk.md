...
| `enableRestEds` | [.google.protobuf.BoolValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/bool-value) | Whether or not to use rest xds for all EDS by default This setting is meant to solve the bug which causes updated upstreams to dissapear, or have 0 endpoints. Some examples are: 1. https://github.com/solo-io/gloo/issues/3673 2. https://github.com/solo-io/gloo/issues/3710 3. https://github.com/solo-io/gloo/issues/3673 Rest XDS, as opposed to grpc, uses http polling rather than streaming. |  |
