...
| `useTls` | [.google.protobuf.BoolValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/bool-value) | Whether or not to use HTTP (false, default) or HTTPS (true) when communicating with this consul upstream. If this configuration includes an SSL config, HTTPS is always used and this value is ignored. |  |
